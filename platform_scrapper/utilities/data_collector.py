...
def clean_data(list_of_circle_sections, store, address):
    # filename = str(store) + str(address)
    # # with open(f"gd_{filename}.json", 'w') as file:
    # #     json.write(list_of_circle_sections)
    # final_data = {}
    ...
    #             if km > c:
    #                 c = km
    #             res[price].append(final_data[price][degree][c])
    return list_of_circle_sections
