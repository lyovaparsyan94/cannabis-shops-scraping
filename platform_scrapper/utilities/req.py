...
null = res.json()['data']['getAddressBasedDispensaryData']['deliveryInfo']['deliveryAreaId']
# pprint.pprint(res.json()['data']['getAddressBasedDispensaryData']['deliveryInfo']['deliveryAreaId'])
pprint.pprint(null)
